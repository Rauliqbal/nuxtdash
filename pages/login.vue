          ...
          <form class="mt-8" action="" method="post">
            <div>
              <label>
                ...
                <Input name="login" class="bg-white" placeholder="email address" />
              </label>
            </div>
            <div class="my-4">
              <label>
                <span class="text-sm font-medium text-gray-700">Password</span>
                <Input name="login" class="bg-white" placeholder="password" />
              </label>
            </div>

            <NuxtLink to="/reset-password" class="text-gray-400 underline hover:text-gray-600 transition-all text-sm ">Forgot password</NuxtLink>
